...
public class LeaveViewFragment extends Fragment implements View.OnClickListener {
    ...
    String country, applied_datetime, email, pincode, employee_first_name, state, phone_no, comment, door_no, employee_last_name, role, leave_id,
            subject,message, city, approved_by, leave_status="", leave_type, department, employee_uuid, to_date, school_id, wing, landmark, employee_photo,
            from_date, locality;
    ...
    private void leaveApproveRejectAPI(String leaveStatus, String comment){
